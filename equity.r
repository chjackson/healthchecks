...
## exclude these
scx <- match(c("Base case","Attenders keep attending","Attenders keep attending, target non-attenders"), scn)
...
scnnowrap <- c("Base case",
               ...
               "Statin treatment x 2.5", "Anti-hypertensive treatment x 2.5",
               "Smoking cessation x 2.5", "Weight loss programme x 2.5",
               "All treatments x 2.5",
               "All treatments x 2.5, eligibility extended, uptake increased")[-scx]

cols <- rep(c("black","black","red","blue"), c(1, 4, 7, 6))[-scx]
...
text(0, 17 - (1:ni)*1.5, paste0(1:3, ": ", scnnowrap[inds]), pos=4, font=2, cex=1.5, col=cols[x>2])
